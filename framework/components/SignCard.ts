...
export class SignCard {
    ...
    constructor(currentPage: Page, container?: Locator) {
        this.locator = container? container :  currentPage.locator('[class = "styles-module-theme-rOnN1"]');
    ...
    async testSignCard(searchData) {
        /*на этом месте застревает: 
        page.getByTestId('item-view/title-info').textContent()
        waiting for getByTestId('item-view/title-info')*/
